...
const unsigned long POMPA_AIR_JEDA    = 30000UL;  // jeda setelah mati sebelum boleh nyala lagi (ms)
...
bool          pompaAirSedangNyala = false; // apakah pompa sedang dalam siklus nyala
...
void loop() {
  ...
  // — Cek timer pompa air real-time (setiap iterasi loop ~ms)
  // Matikan pompa jika sudah menyala 5 detik, tanpa menunggu siklus berikutnya
