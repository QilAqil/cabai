...
|----|------|----------|----------|----------|-------|
| 1 | 27.4 | 0.00 | (31-27.4)/4 = **0.15** | (27.4-27)/4 = **0.10** | **Sedang** |
| 2 | 27.5 | 0.00 | (31-27.5)/4 = **0.13** | (27.5-27)/4 = **0.13** | **Sedang** |
| 3 | 27.5 | 0.00 | **0.13** | **0.13** | **Sedang** |
| 4 | 27.4 | 0.00 | **0.15** | **0.10** | **Sedang** |
| 5 | 27.2 | 0.00 | (31-27.2)/4 = **0.20** | (27.2-27)/4 = **0.05** | **Sedang** |

**Cara menghitung manual (No. 1, Suhu = 27.4°C):**
```
μ_Rendah : 27.4 > 27 → μ = 0.00
μ_Sedang : 27 < 27.4 < 31 → μ = (31 - 27.4) / (31 - 27) = 3.6 / 4 = 0.15 ✓
μ_Tinggi : 27 < 27.4 < 31 → μ = (27.4 - 27) / (31 - 27) = 0.4 / 4 = 0.10
Hasil    : argmax(0.00, 0.15, 0.10) = Sedang
```
...
| 1 | 5.0 | 27.4 | 79 | 1.00 | 0.10 | 0.90 | 1.00 | 0.10 | 0.90 | ✓ |
| 2 | 5.0 | 27.5 | 79 | 1.00 | 0.13 | 0.90 | 1.00 | 0.13 | 0.90 | ✓ |
| 3 | 5.0 | 27.5 | 78 | 1.00 | 0.13 | 0.80 | 1.00 | 0.13 | 0.80 | ✓ |
| 4 | 5.0 | 27.4 | 79 | 1.00 | 0.10 | 0.90 | 1.00 | 0.10 | 0.90 | ✓ |
| 5 | 5.0 | 27.2 | 79 | 1.00 | 0.05 | 0.90 | 1.00 | 0.05 | 0.90 | ✓ |

> **Keterangan kolom μ:**
> - μ pH = nilai derajat keanggotaan himpunan Asam (dominan)
> - μ Suhu = nilai derajat keanggotaan himpunan Tinggi (digunakan rule kipas)
> - μ Tanah = nilai derajat keanggotaan himpunan Basah (dominan)
